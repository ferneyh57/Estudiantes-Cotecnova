...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2019 a las 03:11:04
...
CREATE TABLE `admin` (
  ...
  `admin_nombres` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `admin` (`admin_id`, `admin_nombres`, `admin_usser`, `admin_pass`, `activo`) VALUES
(1, '0', 1192713025, '9815df8d3eebdd7f37f02ca4cc411743', 1),
(3, 'wilder', 16229807, '827ccb0eea8a706c4c34a16891f84e7b', 1);
...
(24, 1114788317, 'sergio', 'arias', 0, '827ccb0eea8a706c4c34a16891f84e7b', 1, 1, 1, 1);
...
(10, 1112776996, 'daniel', 'agudelo', '827ccb0eea8a706c4c34a16891f84e7b', 1, 1, 1);
...
--
ALTER TABLE `estudiantes`
  MODIFY `est_id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Numero de identificacion del estudiante', AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `vendedores`
  MODIFY `ven_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id del vendedor', AUTO_INCREMENT=11;
