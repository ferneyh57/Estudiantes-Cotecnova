                ...
                <?php
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Activar Programa</th>
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td>
                            ...
                            <a href="validacion_activar_vendedor.php?id=<?php echo $resultado['programa_id']; ?>"  class="btn btn-primary glyphicon glyphicon-pencil" name="Activar">activar</a>   
